...
public final class studentGrpc {
  ...
  public static abstract class studentImplBase implements io.grpc.BindableService {
    ...
    public void login(com.student.grpc.Student.LoginRequest request,
        io.grpc.stub.StreamObserver<com.student.grpc.Student.Log_Response> responseObserver) throws SQLException {
        ...
        case METHODID_LOGIN:
          try {
            serviceImpl.login((Student.LoginRequest) request,
                (io.grpc.stub.StreamObserver<Student.Log_Response>) responseObserver);
